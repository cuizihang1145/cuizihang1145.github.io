...
const BLOCKED_WORDS = [
  ...
  '贷款','加微','加V','客服','优惠','特价','免费',
  'ds','gpt','kimi','step','deepseek','gemini','豆包','glm','qwen','千问','minimax','claude','opus','gork','flash','智谱',
  '混元','文心','讯飞','商量','盘古','mimo','sora','open','模型','聚合','代理','key','密钥','充值','余额','最','第一','官方','渠道','仅','史上',
  '彩票','博彩','赌','色情','成人','AV','三级',
  'SEO','排名','推广','营销','广告','招商','权重','秒','租','售','在线','观看',
  '血腥','暴力','砍人','杀人','恐怖','袭击','砍头',
  '点击链接','扫描二维码','加群','加QQ','加微信',
  '特价','促销','折扣','微信','绿泡泡','企鹅','广告','奇',
  '傻逼','妈的','md','tmd','操','艹','提现',
  '庄家','真人发牌','澳门','赌场','百家乐','老虎机','棋牌','捕鱼','mg',
  '电竞竞猜','体育下注','六合彩','跑马','牛牛','扎金花','21点','德州扑克','私彩','盘口','水位',
  '约炮','月抛','约跑','裸聊','同城','交友','上门','特殊','性感','荷官','桑拿','按摩',
  '寂寞','少妇','空姐','御姐','萝莉','嫩模','兼职',
  '引流','脚本','挂','桂','免流','破解','黑客','卡密','套现','办证','杀','互助','微商','代理','催收','贷',

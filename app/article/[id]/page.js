...
export default function ArticlePage({ params }) {
    ...
    return (
      <html lang="zh-CN">
        <head>
          ...
          <title>文章不存在 · ks</title>
          <style>{`
            body { font-family: 'Inter', sans-serif; background: #FAFAFE; color: #1A1A2E; display: flex; justify-content: center; align-items: center; min-height: 100vh; margin: 0; }
            .not-found { text-align: center; padding: 4rem 1rem; color: #8A8AB5; }
  ...
  // 从 post 提取数据，用于注入到页面中
  const articleTitle = post.title || '无标题';
  const articleDate = post.date || '';
  const articleContent = post.content || '（暂无内容）';
  const articleTags = post.tags || [];
  const articleId = id;

  // 注意：renderMarkdown 和所有 JS 逻辑都在下面的 HTML 中执行
  // 数据通过 window.__ARTICLE_DATA__ 注入
...
<head>
    ...
    <style>
        ...
        * {
        ...
        body.dark .reading-progress .progress-bar {
            background: #60A5FA;
        }
        .bg-glow {
            position: fixed;
        ...
        .glow-soft {
            ...
            width: 70vw;
            height: 70vw;
            background: radial-gradient(circle, rgba(160, 130, 230, 0.15), rgba(210, 190, 255, 0) 70%);
            border-radius: 50%;
            top: -25vh;
            right: -20vw;
            z-index: -1;
        ...
        body.dark .glow-soft {
            background: radial-gradient(circle, rgba(120, 100, 200, 0.20), rgba(60, 40, 120, 0) 70%);
        }
        .glow-soft-2 {
            position: fixed;
            width: 50vw;
            height: 50vw;
            background: radial-gradient(circle, rgba(200, 180, 255, 0.10), rgba(255, 240, 255, 0) 70%);
            border-radius: 50%;
            bottom: -15vh;
            left: -10vw;
            z-index: -1;
        ...
        body.dark .glow-soft-2 {
            background: radial-gradient(circle, rgba(90, 70, 160, 0.15), rgba(30, 20, 60, 0) 70%);
        }
        @keyframes floatGlow {
            0% { transform: translate(0, 0) scale(1); opacity: 0.3; }
            100% { transform: translate(5%, 8%) scale(1.2); opacity: 0.7; }
        }
        @keyframes floatGlow2 {
            0% { transform: translate(0, 0) scale(1); opacity: 0.2; }
            100% { transform: translate(-6%, -5%) scale(1.3); opacity: 0.6; }
        }
        .container {
            max-width: 700px;
            margin: 0 auto;
        ...
        .back-to-top-btn {
            ...
            font-size: 1.2rem;
            cursor: pointer;
            transition: opacity 0.35s ease, transform 0.25s ease, background 0.3s ease, box-shadow 0.3s ease;
            box-shadow: 0 6px 20px rgba(80, 60, 160, 0.10);
            opacity: 0;
            pointer-events: none;
            user-select: none;
        ...
        body.dark .article-detail .detail-title {
            color: #E8E6F0;
        }
        ...
        body.dark .article-detail .detail-date {
            color: #7A7AA0;
        }
        .article-detail .detail-tags {
            display: flex;
            flex-wrap: wrap;
            gap: 0.4rem 0.6rem;
            margin-bottom: 1rem;
        }
        .article-detail .detail-tags .tag {
            display: inline-flex;
            align-items: center;
            gap: 0.25rem;
            font-size: 0.75rem;
        ...
        body.dark .article-detail .detail-tags .tag {
            color: #88ccff;
            background: rgba(136, 204, 255, 0.10);
        }
        .article-detail .detail-tags .tag:hover {
            background: rgba(107, 90, 207, 0.20);
            transform: scale(1.04);
        }
        body.dark .article-detail .detail-tags .tag:hover {
            background: rgba(136, 204, 255, 0.20);
        }
        .article-detail .detail-tags .tag i {
            font-size: 0.6rem;
            opacity: 0.7;
        }
        ...
        body.dark .article-detail .detail-divider {
        ...
        body.dark .article-detail .detail-content {
            color: #D0CAF0;
        }
        .article-detail .detail-content h1,
        ...
        body.dark .article-detail .detail-content h1,
        body.dark .article-detail .detail-content h2,
        body.dark .article-detail .detail-content h3,
        body.dark .article-detail .detail-content h4,
        body.dark .article-detail .detail-content h5,
        body.dark .article-detail .detail-content h6 {
            color: #E8E6F0;
        }
        .article-detail .detail-content h1 {
            font-size: 1.8rem;
        ...
        .article-detail .detail-content p:last-child {
            margin-bottom: 0;
        }
        .article-detail .detail-content strong {
            color: #3D2D8A;
            font-weight: 700;
            transition: color 0.3s ease;
        }
        body.dark .article-detail .detail-content strong {
            color: #C8C0F0;
        }
        .article-detail .detail-content em {
            font-style: italic;
            color: #6A6A92;
            transition: color 0.3s ease;
        }
        body.dark .article-detail .detail-content em {
            color: #A8A4C8;
        }
        ...
        body.dark .article-detail .detail-content a {
            color: #88ccff;
        }
        .article-detail .detail-content del {
            color: #8A8AB5;
            text-decoration: line-through;
            transition: color 0.3s ease;
        }
        body.dark .article-detail .detail-content del {
            color: #6A6A8A;
        }
        .article-detail .detail-content u {
            text-decoration: underline;
            text-underline-offset: 2px;
        }
        .article-detail .detail-content kbd {
        ...
        body.dark .article-detail .detail-content kbd {
            background: rgba(255, 255, 255, 0.06);
            border-color: rgba(255, 255, 255, 0.08);
        }
        .article-detail .detail-content mark {
            background: rgba(255, 215, 0, 0.3);
            padding: 0 0.2rem;
            border-radius: 2px;
            transition: background 0.3s ease;
        }
        body.dark .article-detail .detail-content mark {
            background: rgba(255, 215, 0, 0.2);
        }
        .article-detail .detail-content sup {
            font-size: 0.7em;
            vertical-align: super;
        }
        .article-detail .detail-content sub {
            font-size: 0.7em;
            vertical-align: sub;
        }
        ...
        .article-detail .detail-content th,
        .article-detail .detail-content td {
            border: 1px solid rgba(0, 0, 0, 0.08);
            padding: 0.5rem 0.8rem;
            text-align: left;
            transition: border-color 0.3s ease, background 0.3s ease;
        }
        body.dark .article-detail .detail-content th,
        body.dark .article-detail .detail-content td {
        ...
        .article-detail .detail-content tr:nth-child(even) td {
            background: rgba(0, 0, 0, 0.02);
        }
        body.dark .article-detail .detail-content tr:nth-child(even) td {
            background: rgba(255, 255, 255, 0.02);
        }
        .article-detail .detail-content .footnote-ref {
            font-size: 0.75em;
            vertical-align: super;
            text-decoration: none;
            color: #6B5ACF;
        ...
        body.dark .article-detail .detail-content .footnote-ref {
            color: #88ccff;
        }
        .article-detail .detail-content .footnote-ref::before {
            content: '[';
        }
        .article-detail .detail-content .footnote-ref::after {
            content: ']';
        }
        .article-detail .detail-content .footnotes {
            margin-top: 2rem;
            padding-top: 1rem;
            border-top: 1px solid rgba(0, 0, 0, 0.06);
            font-size: 0.85rem;
        ...
        body.dark .article-detail .detail-content .footnotes {
            border-top-color: rgba(255, 255, 255, 0.06);
            color: #8A8AA8;
        }
        .article-detail .detail-content .footnotes .footnote-def {
            margin-bottom: 0.3rem;
            padding-left: 1.8rem;
            position: relative;
        }
        .article-detail .detail-content .footnotes .footnote-def .footnote-back {
            position: absolute;
            left: 0;
            text-decoration: none;
            color: #6B5ACF;
        ...
        body.dark .article-detail .detail-content .footnotes .footnote-def .footnote-back {
            color: #88ccff;
        }
        .article-detail .detail-content ul.task-list {
            list-style: none;
            padding-left: 0.2rem;
        }
        .article-detail .detail-content ul.task-list li {
            display: flex;
            align-items: flex-start;
            gap: 0.3rem;
        }
        .article-detail .detail-content ul.task-list li input[type="checkbox"] {
            margin-top: 0.25rem;
            width: 1rem;
            height: 1rem;
            flex-shrink: 0;
        ...
        .article-detail .detail-content li {
            word-break: break-word;
            white-space: normal;
            max-width: 100%;
            display: list-item;
        ...
        body.dark .img-placeholder .img-loading {
            color: rgba(180, 170, 220, 0.35);
        }
        .img-placeholder.loaded .img-loading {
            opacity: 0;
            pointer-events: none;
        }
        @keyframes spin {
        ...
        body.dark .img-placeholder .img-alt-text {
            color: #8A8AB5;
            background: rgba(0, 0, 0, 0.2);
        }
        .img-placeholder.loaded .img-alt-text {
            display: block;
        }
        ...
        body.dark .article-detail .detail-content img {
            box-shadow: 0 4px 16px rgba(0, 0, 0, 0.2);
        }
        .article-detail .detail-content img:hover {
            box-shadow: 0 8px 32px rgba(0, 0, 0, 0.12);
        }
        body.dark .article-detail .detail-content img:hover {
        ...
        body.dark .article-detail .detail-content code {
            background: rgba(255, 255, 255, 0.06);
            color: #E8A87C;
        }
        ...
        .code-block-header .code-stats span {
            margin: 0 2px;
        }
        .code-block-header .header-actions {
            display: flex;
            align-items: center;
            gap: 4px;
            flex-shrink: 0;
        ...
        .code-block-header .copy-btn i {
            font-size: 0.7rem;
        }
        .code-block-header .collapse-btn {
            width: 28px;
            height: 28px;
            border: none;
            border-radius: 50%;
        ...
        .code-block-header .collapse-btn:hover {
            background: rgba(255, 255, 255, 0.1);
            color: #E8E6F0;
        }
        .code-block-header .collapse-btn:active {
            background: transparent !important;
            outline: none !important;
        }
        .code-block-body-wrapper {
            overflow: hidden;
            transition: max-height 0.4s cubic-bezier(0.34, 1.56, 0.64, 1), opacity 0.3s ease;
            max-height: 3000px;
            opacity: 1;
        }
        .code-block-wrapper.collapsed .code-block-body-wrapper {
        ...
        .code-block-body .code-line .line-number {
            flex-shrink: 0;
            width: 3.2rem;
            text-align: right;
            color: #484F58 !important;
        ...
        .code-block-body .code-line .hljs {
            background: transparent !important;
            padding: 0 !important;
            font-size: 0.85rem;
            line-height: 1.7;
        ...
        .article-detail .detail-content ol li {
            margin-bottom: 0.2rem;
        }
        .article-detail .detail-content ul li ul,
        .article-detail .detail-content ul li ol,
        .article-detail .detail-content ol li ul,
        .article-detail .detail-content ol li ol {
            margin: 0.2rem 0;
        }
        ...
        body.dark .article-detail .detail-content blockquote {
            border-left-color: #88ccff;
            color: #A8A4C8;
        }
        .article-detail .detail-content hr {
            border: none;
            border-top: 2px solid rgba(0, 0, 0, 0.08);
            margin: 1.5rem 0;
            transition: border-color 0.3s ease;
        }
        body.dark .article-detail .detail-content hr {
            border-top-color: rgba(255, 255, 255, 0.08);
        }
        .article-detail .detail-content dl {
            margin: 0.6rem 0;
        }
        .article-detail .detail-content dl dt {
            font-weight: 600;
            color: #3D2D8A;
            margin-top: 0.4rem;
            transition: color 0.3s ease;
        }
        body.dark .article-detail .detail-content dl dt {
            color: #C8C0F0;
        }
        .article-detail .detail-content dl dd {
            margin-left: 1.8rem;
            padding-left: 0.6rem;
            border-left: 2px solid rgba(107, 90, 207, 0.2);
            color: #4A4A6E;
            transition: color 0.3s ease, border-color 0.3s ease;
        }
        body.dark .article-detail .detail-content dl dd {
            color: #A8A4C8;
            border-left-color: rgba(136, 204, 255, 0.2);
        }
        .not-found {
            text-align: center;
            padding: 4rem 1rem;
        ...
        .lightbox-overlay .lightbox-container .lightbox-img-wrapper {
            display: flex;
            justify-content: center;
            align-items: center;
            width: 100%;
        ...
        .lightbox-overlay .lightbox-container .lightbox-img-wrapper:active {
            cursor: grabbing;
        }
        .lightbox-overlay .lightbox-container .lightbox-img-wrapper img {
            max-width: 100%;
            max-height: 70vh;
            border-radius: 0 !important;
            display: block;
        ...
        .lightbox-overlay .lightbox-alt:empty {
            display: none;
        }
        ...
        .lightbox-progress .lb-progress-bar {
            height: 100%;
            width: 0%;
            background: #60A5FA;
            border-radius: 4px;
        ...
        body.dark .share-modal-overlay .share-modal-box {
        ...
        .share-modal-overlay .share-modal-title {
            font-size: 1.1rem;
            font-weight: 600;
            color: #1a1a2e;
            margin-bottom: 0.8rem;
        ...
        body.dark .share-modal-overlay .share-modal-title {
            color: #fff;
        }
        .share-modal-overlay .share-modal-title i {
            margin-right: 0.5rem;
            color: #624ed0;
        }
        body.dark .share-modal-overlay .share-modal-title i {
            color: #88ccff;
        }
        #sharePreviewWrap {
        ...
        .share-modal-actions .btn-text {
            background: rgba(0, 0, 0, 0.06);
            color: #6a6a92;
            border: 1px solid rgba(0, 0, 0, 0.06);
            transition: background 0.3s ease, color 0.3s ease, border-color 0.3s ease;
        }
        .share-modal-actions .btn-text:hover {
            background: rgba(0, 0, 0, 0.1);
        }
        body.dark .share-modal-actions .btn-text {
            background: rgba(255, 255, 255, 0.08);
            color: #9a96b8;
            border-color: rgba(255, 255, 255, 0.06);
        }
        body.dark .share-modal-actions .btn-text:hover {
            background: rgba(255, 255, 255, 0.15);
        }
        .share-modal-actions .btn-image {
            background: linear-gradient(145deg, #7A6BCF, #624ED0);
            color: #fff;
            box-shadow: 0 8px 24px rgba(90, 70, 170, 0.2);
        }
        .share-modal-actions .btn-image:hover {
            transform: scale(1.02);
            box-shadow: 0 12px 32px rgba(90, 70, 170, 0.3);
        }
        body.dark .share-modal-actions .btn-image {
            box-shadow: 0 8px 24px rgba(0, 0, 0, 0.3);
        }
        body.dark .share-modal-actions .btn-image:hover {
            box-shadow: 0 12px 32px rgba(0, 0, 0, 0.4);
        }
        .share-modal-actions .btn-image i {
            font-size: 0.9rem;
        }
        .share-close-btn {
            margin-top: 0.6rem;
        ...
        body.dark .share-close-btn:hover {
            color: #d0caf0;
        }
...
<body>
    ...
    <div class="share-modal-overlay" id="shareModal">
        <div class="share-modal-box">
            <div class="share-modal-title"><i class="fas fa-share-alt"></i> 分享</div>
            <div id="sharePreviewWrap">
                <img id="sharePreviewImg" src="" alt="分享图预览" />
            </div>
            <div class="share-modal-actions">
                <button class="btn-text" id="shareCopyBtn"><i class="fas fa-copy"></i> 复制文字</button>
                <button class="btn-image" id="shareSaveBtn"><i class="fas fa-download"></i> 保存图片</button>
            </div>
            <button class="share-close-btn" id="shareCloseBtn">关闭</button>
        </div>
    </div>

    <div class="share-modal-overlay" id="textModal" style="z-index:1000;">
        <div class="share-modal-box" style="max-width:420px;">
            <div class="share-modal-title"><i class="fas fa-copy"></i> 复制内容</div>
            <div class="share-text-box" id="shareTextDisplay" style="background:rgba(0,0,0,0.04);border-radius:12px;padding:0.8rem 1rem;text-align:left;font-size:0.82rem;line-height:1.8;color:#4a4a6e;word-break:break-all;margin-bottom:1rem;border:1px solid rgba(0,0,0,0.04);max-height:200px;overflow-y:auto;font-family:'Inter',sans-serif;">
                加载中...
            </div>
            <div class="share-modal-actions">
                <button class="btn-text" id="textModalCancel" style="flex:1;">取消</button>
                <button class="btn-image" id="textModalCopy" style="flex:1;"><i class="fas fa-copy"></i> 复制</button>
            </div>
        </div>
    </div>
    ...
    <script>
        // ===== 预注入数据（替代 fetch） =====
        const __ARTICLE_DATA__ = ${JSON.stringify({
          title: articleTitle,
          date: articleDate,
        ...
        function renderMarkdown(md) {
            ...
            function renderInline(text) {
                ...
                html = html.replace(/!\\[([^\\]]*)\\]\\(([^)]*?)(?:\\s+=\\s*(\\d*)(?:x(\\d+))?)?\\)/g, function(match, alt, src, w, h) {
                    let style = '';
                ...
                html = html.replace(/\\[\\^([^\\]]+)\\]/g, function(match, key) {
                    if (!footnoteKeys.includes(key)) footnoteKeys.push(key);
                    return '<sup class="footnote-ref"><a href="#fn-' + key + '" id="fnref-' + key + '">' + key +
                        '</a></sup>';
                });
            ...
            function flushTable() {
                ...
                for (let i = 0; i < tableRows.length; i++) {
                    ...
                    for (let j = 0; j < cells.length; j++) {
                        ...
                        const align = (i === 1 && tableAligns[j]) ? ' style="text-align:' + tableAligns[j] + ';"' : '';
                        const cellContent = cells[j].replace(/\\\\n/g, '\\n').replace(/\\n/g, '<br>');
                        html += '<' + tag + align + '>' + renderInline(cellContent) + '</' + tag + '>';
                    }
                    html += '</tr>';
                }
                html += '</table>';
            ...
            function flushCodeBlock() {
                ...
                let code = codeBlockLines.join('\\n');
                code = code.replace(/^\\s*\\n/, '').replace(/\\n\\s*$/, '');

                const langParts = codeLang.split(/\\s+/);
                const lang = langParts[0] || 'text';
                const copyId = 'code-' + Date.now() + '-' + (codeBlockCounter++);
                ...
                for (let j = 0; j < lines.length; j++) {
                    ...
                    if (lineLen > maxLineLength) maxLineLength = lineLen;
                    totalChars += lineLen;
                }
                totalChars += lineCount > 0 ? lineCount - 1 : 0;

                const statsHtml = '<span>' + lineCount + ' 行</span> · <span>' + maxLineLength + ' 列</span> · <span>' +
                    totalChars + ' 字符</span>';
                ...
                for (let j = 0; j < lines.length; j++) {
                    ...
                    codeHtml += '<span class="code-line"><span class="line-number">' + lineNum + '</span><span class="hljs">' + escapedLine + '</span></span>';
                }

                result += '<div class="code-block-wrapper" id="cbw-' + copyId + '">' +
                    ...
                    '<button class="collapse-btn" data-target="cbw-' + copyId + '">' +
                    '<i class="fas fa-chevron-up"></i>' +
                    '</button>' +
                    '</span>' +
                    '</div>' +
                    '<div class="code-block-body-wrapper">' +
                    '<div class="code-block-body" id="code-body-' + copyId + '">' +
                    codeHtml +
                    '</div>' +
                    '</div>' +
                    '</div>';
            ...
            while (i < lines.length) {
                ...
                if (codeBlockStart) {
                    if (!inCodeBlock) {
                        flushTable();
                        inCodeBlock = true;
                        codeLang = codeBlockStart[2] || 'text';
                        i++;
                        continue;
                    } else {
                        flushCodeBlock();
                ...
                if (fnMatch) {
                    ...
                    footnotes[key] = renderInline(content);
                    if (!footnoteKeys.includes(key)) footnoteKeys.push(key);
                    i++;
                    continue;
                }
                ...
                if (i + 1 < lines.length && lines[i + 1].match(/^:\\s+/)) {
                    flushTable();
                    const term = renderInline(trimmed);
                    let defs = [];
                    i++;
                    ...
                    let ddHtml = defs.map(d => '<dd>' + d + '</dd>').join('');
                    result += '<dl><dt>' + term + '</dt>' + ddHtml + '</dl>';
                    continue;
                }

                function parseList(startIdx, parentIndent) {
                    let html = '';
                    let idx = startIdx;
                    let currentListType = null;
                    let items = [];
                    let olStartNumber = null;
                    let olValues = [];
                    ...
                    while (idx < lines.length) {
                        ...
                        const taskMatch = l.match(/^(\\s*)[-*+]\\s+\\[([ x])\\]\\s+(.+)/);
                        ...
                        if (taskMatch) {
                            ...
                            content = '<input type="checkbox"' + (checked ? ' checked' : '') + ' disabled> ' + taskMatch[3];
                            ...
                            if (indent < parentIndent) break;
                            type = 'ol';
                            olNumber = parseInt(olMatch[2]);
                            content = olMatch[3];
                            if (olStartNumber === null) {
                                olStartNumber = olNumber;
                            }
                            olValues.push(olNumber);
                        ...
                        let childHtml = '';
                        let childIdx = idx + 1;
                        while (childIdx < lines.length && lines[childIdx].trim() === '') childIdx++;
                        if (childIdx < lines.length) {
                            const nextLine = lines[childIdx];
                            const nextUl = nextLine.match(/^(\\s*)[-*+]\\s+/);
                            const nextOl = nextLine.match(/^(\\s*)(\\d+)\\.\\s+/);
                            const nextTask = nextLine.match(/^(\\s*)[-*+]\\s+\\[[ x]\\]\\s+/);
                            if (nextUl || nextOl || nextTask) {
                                const nextIndent = parseInt((nextUl || nextOl || nextTask)[1].length);
                                if (nextIndent > indent) {
                                    const [childHtmlResult, childConsumed] = parseList(childIdx, indent);
                                    childHtml = childHtmlResult;
                                    idx += childConsumed;
                                }
                            }
                        }
                        ...
                        if (!currentListType) {
                            currentListType = type === 'ol' ? 'ol' : 'ul';
                        }

                        const isTask = type === 'task';
                        const liClass = isTask ? ' class="task-list-item"' : '';
                        const renderedContent = renderInline(content);

                        let liTag = '<li' + liClass;
                        if (type === 'ol') {
                            liTag += ' value="' + olNumber + '"';
                        }
                        liTag += '>' + renderedContent + childHtml + '</li>';
                    ...
                    let listClass = '';
                    if (listTag === 'ul') {
                        const hasTask = items.some(item => item.type === 'task');
                        listClass = hasTask ? ' class="task-list"' : '';
                    }
                    let startAttr = '';
                    if (currentListType === 'ol' && olStartNumber !== null && olStartNumber !== 1) {
                        startAttr = ' start="' + olStartNumber + '"';
                    }
                    const itemsHtml = items.map(item => item.html).join('\\n');
                    html = '<' + listTag + listClass + startAttr + '>\\n' + itemsHtml + '\\n</' + listTag + '>';
                    return [html, idx - startIdx];
                }

                const listCheck = line.match(/^(\\s*)[-*+]\\s+/);
                const taskCheck = line.match(/^(\\s*)[-*+]\\s+\\[[ x]\\]\\s+/);
                const olCheck = line.match(/^(\\s*)(\\d+)\\.\\s+/);

                if (taskCheck || listCheck || olCheck) {
                    flushTable();
                    const [listHtml, consumed] = parseList(i, 0);
                    result += listHtml;
                    i += consumed;
                    continue;
                }
                ...
                if (line.startsWith('>')) {
                    ...
                    let innerHtml = renderInline(quoteLines.join('\\n'));
                    for (let lv = 0; lv < level; lv++) {
                        innerHtml = '<blockquote>' + innerHtml + '</blockquote>';
                    }
                    result += innerHtml;
                    i = j;
                    continue;
            ...
            if (footnoteKeys.length > 0) {
                ...
                for (const key of footnoteKeys) {
                    if (footnotes[key]) {
                        result += '<div class="footnote-def" id="fn-' + key + '">';
                        result += '<a href="#fnref-' + key + '" class="footnote-back">↩</a> ';
                        result += footnotes[key];
                        result += '</div>\\n';
                    }
                }
                result += '</div>\\n';
                ...
                .then((module) => {
                    ...
                    init({
                        ...
                        imageUploader: async (file) => {
                            let uploadFile = file;
                            const shouldCompress = !['image/gif', 'image/svg+xml'].includes(file.type);
                            if (shouldCompress) {
                                uploadFile = await compressImage(file, 720, 0.8);
                            }
                            const reader = new FileReader();
                            ...
                            const resp = await fetch('https://comment.cuizi.top/api/upload', {
                                method: 'POST',
        ...
        // 修改后的 renderArticle：直接使用预注入数据
        function renderArticle() {
            const data = __ARTICLE_DATA__;
            const idx = data.id;

            if (!data.title) {
                appContent.innerHTML = '<div class="not-found"><i class="far fa-frown"></i><p>文章不存在</p><p style="font-size:0.85rem; margin-top:0.5rem;">可能已被删除</p></div>';
                return;
            }

            currentArticle = data;
            document.title = (currentArticle.title || '文章详情') + ' · ks';

            const title = currentArticle.title || '无标题';
            const date = currentArticle.date || '';
            const content = currentArticle.content || '（暂无内容）';
            const tags = currentArticle.tags || [];
            let renderedContent = renderMarkdown(content);

            renderedContent = renderedContent.replace(/<img\\s+src="([^"]*)"\\s+alt="([^"]*)"([^>]*)>/g, function(
                match, src, alt, rest) {
                const altText = alt || '';
                const altHtml = altText ? '<span class="img-alt-text">' + altText + '</span>' : '';
                return '<div class="img-placeholder"><span class="img-loading"><i class="fas fa-spinner fa-spin"></i></span><img src="' +
                    src + '" alt="' + alt + '"' + rest + '>' + altHtml + '</div>';
            });

            const wordCount = countWords(content);
            const readTime = calculateReadTime(wordCount);

            const preview = getPlainPreview(content, 80);
            const articleUrl = window.location.origin + window.location.pathname;
            currentShareText = title + '：' + preview + '\\n查看完整内容？请访问：' + articleUrl;
            ...
            if (tags.length > 0) {
                ...
                tags.forEach(function(tag) {
                    ...
                    tagsHtml += '<span class="tag" data-tag="' + tagName + '"><i class="fas fa-tag"></i> ' + tagName + '</span>';
                });
                tagsHtml += '</div>';
            }

            appContent.innerHTML = '<div class="article-detail">' +
                '<h1 class="detail-title">' + escapeHtml(title) + '</h1>' +
                '<span class="detail-date">' + (date ? escapeHtml(date) + '  ·  ' : '') + '大约 ' + readTime + ' 分钟 · ' + wordCount + ' 字</span>' +
                tagsHtml +
                '<hr class="detail-divider">' +
                '<div class="detail-content">' + renderedContent + '</div>' +
                '</div>';

            document.querySelectorAll('.code-line .hljs').forEach(el => {
                try {
            ...
            const images = document.querySelectorAll('.detail-content .img-placeholder img');
            const allImages = [];
            images.forEach(img => {
        ...
        // 以下所有函数（openLightbox、generateShareImage 等）完全保留，不做任何改动
        ...
        function updateLbProgress(value) {
            if (!lbProgressBarEl) return;
            lbProgressBarEl.style.width = value + '%';
        }
        ...
        document.addEventListener('click', function(e) {
            ...
            if (copyBtn) {
                ...
                const codeLines = wrapper.querySelectorAll('.code-line');
                let text = '';
                ...
                try {
                    ...
                    if (success) {
                        ...
                        showToast('复制失败', 'fa-exclamation-circle');
                    }
                } catch (err) {
                    showToast('复制失败', 'fa-exclamation-circle');
                }
